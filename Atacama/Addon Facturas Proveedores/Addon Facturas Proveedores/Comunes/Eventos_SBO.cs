...
namespace Addon_Facturas_Proveedores.Comunes
{
    ...
    public class Eventos_SBO
    {
        ...
        private static void CargarCamposConfVali()
        {
            SAPbobsCOM.UserTablesMD oUserTablesMD;
           
            try
            {
                  AddTable("SEI_SETVALH", "configuracion", BoUTBTableType.bott_Document);
                  AddTable("SEI_SETVALL2", "maximo minimo",BoUTBTableType.bott_DocumentLines);
