                                                ...
                                                else
                                                {
                                                    ...
                                                    if (result.Success)
                                                    {
                                                        ...
                                                        if (objDTE.Referencia.Count > 0)
                                                        {
                                                            ...
                                                            dtDoc.SetValue("co_DocRef", IndexMatrix, DocRef.PadRight(200));
                                                            dtDoc.SetValue("co_NroRef", IndexMatrix, NroRef.PadRight(200));
                                                            dtDoc.SetValue("co_FecRef", IndexMatrix, FecRef.PadRight(200));
                                                            dtDoc.SetValue("co_RzRef", IndexMatrix, RzRef.PadRight(200));
